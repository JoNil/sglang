...
class C4IndexerBackendMixin:
    ...
    def forward_c4_indexer(
        ...
        if use_fp4_indexer:
            ...
            # The vectorized SM120 fallback is architecture-neutral and also
            # handles the (batch, 1) graph metadata layout used on SM110.
            if is_sm110_supported() or is_sm120_supported():
